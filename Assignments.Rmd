...
#  geom_smooth(data = filter(mpg, class == "subcompact"), se = FALSE)
  # this chunk had to be commented out because there was an issue with the "subcompact" class
```
...
#This chunk had to be commented out because there was an error with the tribble function
```
...
#This chunk had to be commented out because of an error with tibble()
```
...
#commented out because it relied on best_in_class above
```
...
#commented out because of %/% issue
```
...
#Just to show that the above code is the same as the one below this line...proving that ggplot2 adds scales automatically when it is not specified. 
...
#commented out because of tibble() error
```
...
#commented out because it relies on dataframe that was commented out earlier
```
