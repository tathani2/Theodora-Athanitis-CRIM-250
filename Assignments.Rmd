...
**Answer: By plotting the histograms together, we can learn that histograms for Rape and Murder are (relatively) right-skewed whereas the histogram for Assault is closer to a normal distribution. **
...
library('maps')  
#this line loads the newly-installed "maps" packages
library('ggplot2') 
